...
const categoryImages: Record<VenueCategory, string> = {
  restaurant:
  ...
  museum:
    'https://images.unsplash.com/photo-1566127992631-137a642a90f4?auto=format&fit=crop&w=1200&q=80',
  event:
...
export const sanJoseVenues: Venue[] = [
  makeVenue({
    id: 'sj-petiscos',
    name: 'Petiscos',
  ...
  makeVenue({
    ...
    category: 'bar',
    priceTier: '$$$',
    formattedAddress: '43 W San Salvador St, San Jose, CA 95113, USA',
    latitude: 37.32991507979461,
    longitude: -121.88654414825072,
    tags: ['speakeasy', 'cocktails', 'date-night'],
    useCases: ['romantic', 'socialite'],
    vibeTags: ['cozy', 'creative', 'culture'],
    energyLevel: 3,
    ...
    isChain: false,
    shortDescription: 'Below-ground cocktail lounge with intimate downtown energy.',
    narrativeFlavor: 'A romantic highlight anchor with real speakeasy texture.',
    isHiddenGem: true,
    local: [0.78, 0.82, 0.66],
    roles: [0.42, 0.88, 0.78, 0.62],
  }),
  makeVenue({
    id: 'sj-paper-plane',
    name: 'Paper Plane',
  ...
  makeVenue({
    ...
    category: 'activity',
    priceTier: '$$',
    formattedAddress: '52 E Santa Clara St, San Jose, CA 95113, USA',
    latitude: 37.336808400082525,
    longitude: -121.8893379180668,
  ...
  makeVenue({
    ...
    category: 'museum',
    priceTier: '$$',
    formattedAddress: '201 S Market St, San Jose, CA 95113, USA',
    latitude: 37.33150162687056,
    longitude: -121.8902328140428,
  ...
  makeVenue({
    ...
    category: 'restaurant',
    priceTier: '$$$$',
    formattedAddress: '1614 Alum Rock Ave, San Jose, CA 95116, USA',
    latitude: 37.351766378228994,
    longitude: -121.85844716899318,
  ...
  makeVenue({
    ...
    category: 'activity',
    priceTier: '$$',
    formattedAddress: '748 Story Rd, San Jose, CA 95112, USA',
    latitude: 37.32626737055341,
    longitude: -121.86086606899416,
    tags: ['zoo', 'family-friendly', 'outdoor-play'],
    useCases: ['curator'],
    ...
    shareabilityScore: 0.76,
    isChain: false,
    shortDescription: 'Zoo, rides, and play areas with a defined family-friendly footprint.',
    narrativeFlavor: 'A real family anchor for mid-supply San Jose pocket routing.',
    isHiddenGem: false,
    local: [0.78, 0.82, 0.74],
    roles: [0.58, 0.84, 0.5, 0.56],
  }),
  makeVenue({
  ...
  makeVenue({
    id: 'sj-evergreen-coffee-company',
    name: 'Evergreen Coffee Company',
    neighborhood: 'Evergreen Village',
    driveMinutes: 22,
    category: 'cafe',
    priceTier: '$$',
    formattedAddress: '4075 Evergreen Village Square #150, San Jose, CA 95135, USA',
    latitude: 37.315445420756696,
    longitude: -121.77378393177693,
    tags: ['coffee', 'cozy', 'neighborhood'],
    useCases: ['romantic', 'curator'],
    vibeTags: ['cozy', 'relaxed', 'culinary'],
    energyLevel: 1,
    socialDensity: 2,
    ...
    shareabilityScore: 0.68,
    isChain: false,
    shortDescription: 'Evergreen Village cafe with quiet, conversation-friendly pacing.',
    narrativeFlavor: 'A sparse-area romantic anchor that keeps the plan cozy rather than nightlife-coded.',
    isHiddenGem: false,
    local: [0.74, 0.78, 0.72],
    roles: [0.86, 0.48, 0.5, 0.84],
  }),
  makeVenue({
    id: 'sj-village-grill',
    name: 'Village Grill',
    ...
    category: 'restaurant',
    priceTier: '$$',
    formattedAddress: '4075 Evergreen Village Square #120, San Jose, CA 95135, USA',
    latitude: 37.31438909671919,
    longitude: -121.77320854504963,
    tags: ['casual-american', 'group-friendly', 'neighborhood'],
    useCases: ['socialite', 'curator'],
    vibeTags: ['lively', 'relaxed', 'culinary'],
    energyLevel: 3,
    socialDensity: 3,
    uniquenessScore: 0.68,
    distinctivenessScore: 0.63,
    underexposureScore: 0.52,
    shareabilityScore: 0.72,
    isChain: false,
    shortDescription: 'Casual Evergreen Village grill with approachable group energy.',
    narrativeFlavor: 'A sparse-area friends anchor with enough social gravity for a live-world test.',
    isHiddenGem: false,
    local: [0.72, 0.76, 0.7],
    roles: [0.54, 0.78, 0.56, 0.5],
  }),
  makeVenue({
    id: 'sj-alum-rock-park',
    name: 'Alum Rock Park',
    neighborhood: 'Alum Rock',
    driveMinutes: 24,
    category: 'park',
    priceTier: '$',
    formattedAddress: '15350 Penitencia Creek Rd, San Jose, CA 95127, USA',
    latitude: 37.395578945098094,
    longitude: -121.82526828737421,
    tags: ['park', 'trails', 'broad-area'],
    useCases: ['curator', 'romantic'],
    vibeTags: ['outdoors', 'relaxed', 'cozy'],
    energyLevel: 2,
    uniquenessScore: 0.82,
    distinctivenessScore: 0.8,
    ...
    shareabilityScore: 0.74,
    isChain: false,
    shortDescription: 'Broad-area East San Jose park anchor with sparse nearby commercial density.',
    narrativeFlavor: 'A family-safe sparse stress-test anchor with accepted broad-area risk.',
    isHiddenGem: false,
    local: [0.8, 0.86, 0.7],
    roles: [0.78, 0.58, 0.72, 0.86],
  }),
]

export const denverVenues: Venue[] = [
  makeVenue({
...
export const curatedVenues: Venue[] = [...sanJoseVenues, ...denverVenues]
