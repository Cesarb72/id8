...
import {
  resolveFieldInterpretationVenueIdentityHandoffs,
  type FieldIdentityResolutionInput,
} from '../field/resolveFieldInterpretationVenueIdentityHandoffs'
import {
...
export type Stage2AFieldIdentityResolutionInput = FieldIdentityResolutionInput
...
export function resolveStage2AFieldInterpretationVenueIdentityHandoffs(
  ...
  return resolveFieldInterpretationVenueIdentityHandoffs(inputs)
}
