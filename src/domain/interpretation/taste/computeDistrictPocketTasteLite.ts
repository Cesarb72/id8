import type { IdentifiedPocket } from '../../../engines/district/types/districtTypes'

function toFixed(value: number): number {
  return Number(Math.max(0, Math.min(1, value)).toFixed(3))
}

export function computeDistrictPocketTasteLite(
...
export const computeTasteLite = computeDistrictPocketTasteLite
