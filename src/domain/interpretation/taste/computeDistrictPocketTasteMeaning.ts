...
import type { TastePocketMeaning } from './districtTasteBridgeArtifact'

type MixKey = keyof DistrictTasteSignals['hospitalityMix']

export type DistrictPocketTasteMeaning = DistrictTasteSignals &
  Pick<
    TastePocketMeaning,
    | 'experientialTags'
    | 'hospitalityMix'
...
// Temporarily returns DistrictTasteSignals for compatibility while Taste owns the meaning.
export function computeDistrictPocketTasteMeaning(
  pocket: IdentifiedPocket,
): DistrictPocketTasteMeaning {
...
export const computeTasteBridgeSignals = computeDistrictPocketTasteMeaning
