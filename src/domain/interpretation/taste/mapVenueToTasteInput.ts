import type { NormalizedVenueTasteInput } from './types'
...
function deriveTasteHoursStatus(
  venue: Venue,
): NormalizedVenueTasteInput['hoursStatus'] {
  if (
...
function deriveSeedCalibratedTasteProfile(
  venue: Venue,
): NormalizedVenueTasteInput['seedCalibratedProfile'] {
...
export function mapVenueToTasteInput(venue: Venue): NormalizedVenueTasteInput {
