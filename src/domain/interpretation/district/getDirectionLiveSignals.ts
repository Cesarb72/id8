...
interface DirectionCategoryMix {
  drinks: number
  dining: number
  culture: number
  cafe: number
...
interface DirectionLiveSignalInput {
  tags: string[]
  categoryMix: DirectionCategoryMix
...
interface DirectionLiveSignalContext {
  persona?: PersonaMode
  vibe?: VibeAnchor
  timeWindow?: string
}

export interface DirectionLiveSignals {
  title: string
  items: string[]
}
...
function hasTag(tags: Set<string>, terms: string[]): boolean {
...
export function getDirectionLiveSignals(
  direction: DirectionLiveSignalInput,
  context: DirectionLiveSignalContext,
): DirectionLiveSignals {
