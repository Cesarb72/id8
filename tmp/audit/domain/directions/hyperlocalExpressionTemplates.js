...
export const HYPERLOCAL_REASON_TEMPLATES = {
...
export const HYPERLOCAL_REASON_TITLE_SIGNALS = {
...
const FAMILY_SUBTITLE_TEMPLATES = {
...
export function toDisplayToken(value) {
...
export function resolveReasonTemplate(reasonKey) {
    return (HYPERLOCAL_REASON_TEMPLATES[reasonKey] ??
        `Signal remains ${normalizeToken(reasonKey)}.`);
}
export function resolveReasonTitleSignal(reasonKey) {
    return HYPERLOCAL_REASON_TITLE_SIGNALS[reasonKey] ?? 'Balanced Mix';
}
function isExpressionFamily(value) {
    return (value === 'social' ||
        value === 'cultural' ||
        value === 'playful' ||
        value === 'intimate' ||
...
export function getExpressionFamilyMode(family, confidence) {
