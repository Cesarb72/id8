...
function mergeRule(base, patch) {
    return {
        ...
        maxEnergyLevel: typeof patch.maxEnergyLevel === 'number'
...
function tightenForStrictShape(rule) {
    ...
    return {
        ...
        maxEnergyLevel: typeof rule.maxEnergyLevel === 'number'
...
export function getRoleContract({ intent, starterPack, strictShapeEnabled = false, }) {
    const base = {
