import { normalizeIntent } from './audit-build/src/domain/intent/normalizeIntent.js'
import { buildExperienceLens } from './audit-build/src/domain/intent/buildExperienceLens.js'
import { getCrewPolicy } from './audit-build/src/domain/intent/getCrewPolicy.js'
import { getRoleContract } from './audit-build/src/domain/contracts/getRoleContract.js'
import { retrieveVenues } from './audit-build/src/domain/retrieval/retrieveVenues.js'
import { scoreVenueCollection } from './audit-build/src/domain/retrieval/scoreVenueFit.js'
import { buildRolePools } from './audit-build/src/domain/arc/buildRolePools.js'
import { recommendDistricts } from './audit-build/src/domain/interpretation/district/recommendDistricts.js'
import { resolveDistrictAnchor } from './audit-build/src/domain/interpretation/district/resolveDistrictAnchor.js'
import { getVenueClusterId } from './audit-build/src/domain/spatial/getVenueClusterId.js'
import { detectMomentsFromTaste } from './audit-build/src/domain/interpretation/taste/detectMoments.js'
import { aggregateTasteOpportunityFromVenues } from './audit-build/src/domain/interpretation/taste/aggregateTasteOpportunityFromVenues.js'
...
const strongHighlightCandidates = scored
  .map((sv) => {
    ...
    const highlightSignal =
      s.roleSuitability.highlight * 0.4 +
