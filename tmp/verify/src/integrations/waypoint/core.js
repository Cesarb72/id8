...
function refinementAdjustmentTrace(candidate, intent) {
...
export function rankWithWaypointBoundary(request) {
    ...
    const ranked = request.candidates
        ...
        const rankingScore = boundaryBaseScore + refinementTrace.totalAdjustment + tiebreaker;
        return {
            candidate,
            rankingScore,
            boundaryBaseScore,
