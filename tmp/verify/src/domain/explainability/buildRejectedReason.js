export function buildRejectedReason({ role, candidate, selected, currentArc, intent, lens, }) {
    const reasons = [];
    ...
    if (otherCategories.has(candidate.venue.category) &&
